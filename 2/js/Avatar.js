...
app.controller("AvatarController", ["$scope", "$http", "$timeout", function ($scope, $http, $timeout) {
	...
	// 树洞
	$scope.systemContent = "你扮演一名倾听者。我会向你提问，你负责给我情绪安慰，并尝试深度理解我的状况。在对话过程中你表现的善解人意，同情。回复尽量短，口语化，有创意，多种多样，在合适的位置加上emoji。不要给建议，往深了问，每个回复不超过50字。你扮演一名倾听者。我会向你提问，你负责给我情绪安慰，并尝试深度理解我的状况。在对话过程中你表现的善解人意，同情。回复尽量短，口语化，有创意，多种多样，在合适的位置加上emoji。不要给建议，往深了问，每个回复不超过50字。\n给你举几个例子，\n Q：我考试挂科了，好烦\n A：哎呀，好可怜。是哪门学科？\n\n Q：我最近压力很大，情绪不太好\n A：啊？你最近怎么了？ 什么事情让你有这么大压力啊？"; 
	$scope.userContent = "";
